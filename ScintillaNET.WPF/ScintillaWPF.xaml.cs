...
namespace ScintillaNET.WPF
{
    ...
    public partial class ScintillaWPF : UserControl
    {
        ...
        //original
        private readonly MyScintilla mInnerScintilla;
        public MyScintilla Scintilla { get { return mInnerScintilla; } }

        public ScintillaWPF()
        {
            InitializeComponent();
            //this.mInnerScintilla = new SN.Scintilla(); // original
            this.mInnerScintilla = new MyScintilla();
        ...
        */
        ...
        // AVB
        /// <summary>
        /// Occurs when a Cmd key is pressed while the control has focus.
        /// </summary>
        [Category("Notifications")]
        [Description("Occurs when a Cmd key is pressed while the control has focus.")]
        public event System.Windows.Forms.KeyEventHandler CmdKeyPressed
        {
            add { mInnerScintilla.CmdKeyPressed += value; }
            remove { mInnerScintilla.CmdKeyPressed -= value; }
        }
        ...
        // It allows for binding through ScintillaWPF instead of the inner scintilla
        [Category("Notifications")]
        [Description("Occurs when the editor text is changed.")]
